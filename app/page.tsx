      ...
      <header className="bg-white shadow">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Regrowth Website Builder</h1>
              <p className="text-gray-600">Create shareable websites for your prospects</p>
            </div>
        ...
        <div className="px-4 py-6 sm:px-0">
          <div className="text-center">
            <h2 className="text-4xl font-bold text-gray-900 mb-8">
              Welcome to Regrowth Website Builder
            </h2>
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Create professional, shareable websites for gyms, restaurants, cafes, 
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600">Websites automatically delete after 3 days for security</p>
              </div>
            </div>
